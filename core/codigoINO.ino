...
const char* serverName = "http://localhost:3000/api/postData"; // rora atualizada
  ...
  void enviarDados(float temperatura, float valor_pH, int waterLevel) 
    {
      if (WiFi.status() == WL_CONNECTED) 
        {
          HTTPClient http;
          const char* serverName = "http://localhost:3000/api/postData"; // URL do servidor
...
// ********************* 1 - Imprimir hora a cada 10 segundos ***************** //
  ...
  // ********************* Fim - 1 - Imprimir hora a cada 10 segundos ***************** //


// ***************** 2 - Sensores de gás, temperatura e umidade do ar e luz a cada 5 segundos ************** //
...
// ***************** Fim - 2 - Sensores de gás, temperatura e umidade do ar a cada 5 segundos ************** //


// *********************** 3 - Sensor umidade do solo a cada 4 segundos ******************** //
...
// *********************** Fim - 3 - Sensor umidade do solo a cada 4 segundos ******************** //
